...
c.execute('''CREATE TABLE openaq ( Id int primary key, [Country Code] varchar(5), [City] varchar(100), [Location] varchar(100), [Coordinates] float, [Pollutant] varchar(10), [Source Name] varchar(10), [Unit] varchar(10), [Value] float, [Last Updated] varchar(100), [Country Label] varchar(50))''')
